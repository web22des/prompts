...
- Проект: небольшой сайт, тематика Уборка в доме, уборка в офисе, услуги горничной. Рабочее название "Clining-01"

# ЗАДАЧА:

Есть стартовый шаблон, в котором есть готовая логика. Цель шаблона - облегчить и ускорить верству в будущем. Так как многие написанные компоненты можно переиспользовать. Смысл сделать стартовый шаблон по принципу конструктора, но для разработчика. Название секций в шаблоне = названию секций в дизайн библиотеке.
Задача на сегодня - использовать имеющийся шаблон, сверстать секции по дизайну. Задачи буду скидывать по мере поступления.
...
4. Учитывай методичку при создании компонента

# ВВОДНЫЕ ДАННЫЕ:

напишу в чате, все ли тебе понятно? Короткий ответ.
